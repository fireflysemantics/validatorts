...
test('isCurrency', ()=>{
  runtest(testdata, isCurrency)
})
const testdata: TestData[] = [
  {
    it: '-$##,###.## (en-US, en-CA, en-AU, en-NZ, en-HK)',
    valid: [
      '-$10,123.45',
      '$10,123.45',
      '$10123.45',
  ...
  {
    it: '-$##,###.## with $ required (en-US, en-CA, en-AU, en-NZ, en-HK',
    args: [
      {
        require_symbol: true,
      },
  ...
  {
    it: '$##,###.## with no negatives (en-US, en-CA, en-AU, en-HK)',
    args: [
      { allow_negatives: false },
    ],
        valid: [
